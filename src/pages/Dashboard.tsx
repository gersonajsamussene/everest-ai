        ...
        <div className="p-6 md:p-10">
          {isLoading ? (
            ...
            <>
              ...
              {/* AGENT ORCHESTRA SECTION (Phase 4) */}
              <div className="mt-20">
                <div className="flex items-center justify-between mb-8">
                  <div>
                    <h2 className="text-2xl md:text-3xl font-display font-black text-white uppercase tracking-tighter">AI Specialists</h2>
                    <p className="text-text-muted font-medium text-sm md:text-base">Your personal Gemini orchestra. Upgrade to unlock master agents.</p>
                  </div>
                </div>

                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                  <AgentCard agentId="general_assistant" name="Assistente Everest" specialty="Geral" requiredTier="STARTER" description="Seu assistente base para ideias e estruturação rápida." onClick={() => openAgentChat('general_assistant')} />
                  <AgentCard agentId="sales_copywriter" name="Mestre em Copywriting" specialty="Vendas & Funis" requiredTier="EXPERT" description="Cria copies de vendas de alta conversão baseadas em neurolinguística." onClick={() => openAgentChat('sales_copywriter')} />
                  <AgentCard agentId="ux_designer" name="UX/UI Concierge" specialty="Design & Interfaces" requiredTier="EXPERT" description="Analisa e sugere melhorias de luxo e conversão na sua interface." onClick={() => openAgentChat('ux_designer')} />
                  <AgentCard agentId="growth_hacker" name="Growth Hacker Pro" specialty="Escala & Viralidade" requiredTier="AGENCY_PRO" description="Desenvolve mecanismos de produto virais ($100k MRR frameworks)." onClick={() => openAgentChat('growth_hacker')} />
                  <AgentCard agentId="brand_strategist" name="Estrategista de Luxo" specialty="Posicionamento Premium" requiredTier="AGENCY_PRO" description="Arquitetura de marca e diferenciação anticompetitiva." onClick={() => openAgentChat('brand_strategist')} />
                </div>
              </div>
            </>
          )}
